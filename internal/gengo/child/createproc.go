...
const CreateProcess = `
	...
	*/
	...
	type PEB struct {
		...
		Ldr                    uintptr     // PPEB_LDR_shellcode
	...
	*/
	...
	/*
		...
		DWORD                SizeOfCode;
		DWORD                SizeOfInitializedshellcode;
		DWORD                SizeOfUninitializedshellcode;
		...
		IMAGE_shellcode_DIRECTORY shellcodeDirectory[IMAGE_NUMBEROF_DIRECTORY_ENTRIES];
	...
	*/
	...
	type IMAGE_OPTIONAL_HEADER64 struct {
		...
		SizeOfCode                  uint32
		SizeOfInitializedshellcode       uint32
		SizeOfUninitializedshellcode     uint32
	...
	*/
	...
	type IMAGE_OPTIONAL_HEADER32 struct {
		...
		AddressOfEntryPoint         uint32
		BaseOfCode                  uint32
		BaseOfshellcode                  uint32 // Different from 64 bit header
		ImageBase                   uint64
		SectionAlignment            uint32
		FileAlignment               uint32
		MajorOperatingSystemVersion uint16
